...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 15 Janvier 2015 à 02:12
...
INSERT INTO `gia_xuat` (`id_gia_xuat`, `id_san_pham`, `gia_xuat`, `id_kenh_phan_phoi`, `kho`) VALUES
(1, 53, 9800, 39, 1),
(2, 53, 9600, 40, 1),
(3, 53, 9400, 41, 1),
(4, 53, 9200, 42, 1),
...
INSERT INTO `san_pham` (`id_san_pham`, `ma_san_pham`, `ten_san_pham`, `mo_ta`, `hinh_anh`, `nhan`, `id_don_vi_tinh`, `id_loai`, `ton_kho`, `loai_gia`, `gia_nhap`, `gia_bia`, `chiec_khau`, `kho`) VALUES
(53, 'vietbi', 'Viáº¿t bi', '<p><br></p>', 'photo_default.png', 'vietbi', 4, 9, 0, 1, 8000, 10000, 20, 1),
(54, 'caythuoc', 'CÃ¢y thÆ°á»›c', '<p><br></p>', 'photo_default.png', 'caythuc', 4, 9, 0, 0, 20000, 0, 0, 1);
