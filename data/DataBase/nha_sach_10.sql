...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2014 at 12:48 AM
...
(19, 'KH LÆ°u Kim Loan', 'Tiá»ƒu Cáº§n, TrÃ  Vinh', 'luukimloan@gmail.com', '<p>LÃ  Láº­p TrÃ¬nh ViÃªn sÃ¡ng giÃ¡ nháº¥t</p>', 9879876, 9765987, 'photo_default.png', 'luukimloan.vn', 'luukimloan.twitter', 45, 43, '2014-11-01'),
...
(1, '1214-0001', '2014-12-01', 15, NULL);
...
CREATE TABLE IF NOT EXISTS `phieu_chi` (
  ...
  `ngay_xuat_phieu_chi` date NOT NULL,
...
INSERT INTO `phieu_nhap` (`id_phieu_nhap`, `ma_phieu_nhap`, `ngay_nhap`, `id_doi_tac`, `id_user_nv`) VALUES
(1, '004530', '2014-12-01', 20, 1),
(2, '004704', '2014-12-01', 20, 1);
...
CREATE TABLE IF NOT EXISTS `phieu_thu` (
  ...
  `ly_do` longtext,
  `so_tien` float NOT NULL,
  `ngay_xuat_phieu_thu` date NOT NULL,
...
(27, 'sgkto01', 'SGK ToÃ¡n Lá»›p 01', '<p>SGK ToÃ¡n Lá»›p 01<br></p>', 'photo_default.png', 'SGK', 50, 24, 992, 0),
(28, 'sgkto2', 'SGK ToÃ¡n Lá»›p 02', '<p>SGK ToÃ¡n Lá»›p 02<br></p>', 'photo_default.png', 'SGK', 50, 24, 1944, 0),
(29, 'sgkto3', 'SGK ToÃ¡n Lá»›p 03', '<p>SGK ToÃ¡n Lá»›p 03<br></p>', 'photo_default.png', 'SGK', 50, 24, 96, 0),
(30, 'sgkto4', 'SGK ToÃ¡n Lá»›p 04', '<p>SGK ToÃ¡n Lá»›p 04<br></p>', 'photo_default.png', 'SGK', 50, 24, 15, 0);
