...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2014 at 02:54 AM
...
(27, 'sgkto1', 'SGK ToÃ¡n Lá»›p 01', '<p>SGK ToÃ¡n Lá»›p 01<br></p>', 'photo_default.png', 'SGK', 50, 37, 3010, 10000),
(28, 'sgkto2', 'SGK ToÃ¡n Lá»›p 02', '<p>SGK ToÃ¡n Lá»›p 02<br></p>', 'photo_default.png', 'SGK', 50, 24, 9010, 30000),
(29, 'sgkto3', 'SGK ToÃ¡n Lá»›p 03', '<p>SGK ToÃ¡n Lá»›p 03<br></p>', 'photo_default.png', 'SGK', 50, 24, 760, 5000),
(30, 'sgkto4', 'SGK ToÃ¡n Lá»›p 04', '<p>SGK ToÃ¡n Lá»›p 04<br></p>', 'photo_default.png', 'SGK', 50, 24, 4, 1000),
...
INSERT INTO `user` (`user_id`, `username`, `password`, `display_name`, `ho_ten`, `dia_chi`, `email`, `state`, `mo_ta`, `dien_thoai_co_dinh`, `di_dong`, `hinh_anh`, `website`, `twitter`) VALUES
(1, 'phanvanthanh', 'fasdf', 'Phan Van Thanh', 'Phan Van Thanh', 'Cau ke', 'phanvanthanhda10tt@gmail.com', 0, 'fnmdfasdf', 74, 1699580585, 'photo_default.png', NULL, NULL);
